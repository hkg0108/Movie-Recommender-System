...
-> Let's say I've searched for Avengers which is action movie. So it has tag Action and based on this, tag system has recommend me IronMan Movie and other Avenger's movies.

-> In this project I have used a dataset with 10,000 records.
...
-> After that I am going to calculate **cosine similarity** which means suppose I have max 10,000 dimensions and I am not going to count the eucleadian distance of dimensions but I am going to calcuate **theta** angle between the 2 dimensions to check their distance.
